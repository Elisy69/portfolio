export const text = {
  ...
  "AboutMe_1": {
    ...
    ru: "В целом имею больше года опыта коммерческой разработки. Пишу на JavaScript/TypeScript, для работы и в проектах использую Vue и React. По части других технологий - Вы можете посмотреть ",
  },
